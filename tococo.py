...
if __name__ == '__main__':
    ...
    parser.add_argument('-ap', '--anno-path', type=str, default="C:\\intel\\OpenVINO-YOLOV4\\INT8\\coco128\\labels", help='yolo txt path')
    parser.add_argument('-s', '--save-path', type=str, default="C:\\intel\\OpenVINO-YOLOV4\\INT8\\coco128\\annotations", help='json save path')
    parser.add_argument('--image-path', default="C:\\intel\\OpenVINO-YOLOV4\\INT8\coco128\\images")
    parser.add_argument('--json-name', default='val2017.json')
    ...
    if len(sys.argv) > 1:
        ...
        anno_path = 'C:\\intel\\OpenVINO-YOLOV4\\INT8\\coco128\\labels'
        save_path = 'C:\\intel\\OpenVINO-YOLOV4\\INT8\\coco128\\annotations'
        image_path = 'C:\\intel\\OpenVINO-YOLOV4\\INT8\coco128\\images'
        json_name = 'output2.json'
